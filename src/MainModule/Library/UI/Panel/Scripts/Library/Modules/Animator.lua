...
function module.Window.animateIn(Object: GuiObject, UIScale: UIScale, Duration: number | nil)
	...
	module.Latte.Modules.Tween.new(
		UIScale,
		module.Latte.Modules.TweenInfo[module.EasingData.Window](Duration),
		{ Scale = 1 }
	)
end
...
function module.Window.animateOut(Object: GuiObject, UIScale: UIScale, Duration: number | nil)
	...
	module.Latte.Modules.Tween.new(
		UIScale,
		module.Latte.Modules.TweenInfo[module.EasingData.WindowOut](Duration),
		{ Scale = 0.95 }
...
function module.Menu.animateIn(Object: GuiObject, Duration: number | nil)
	...
	module.Latte.Modules.Tween.new(
		Object,
		module.Latte.Modules.TweenInfo[module.EasingData.Menu](Duration),
...
function module.Menu.animateOut(Object: GuiObject, Duration: number | nil)
	...
	module.Latte.Modules.Tween.new(
		Object,
		module.Latte.Modules.TweenInfo[module.EasingData.MenuOut](Duration),
		{ Position = UDim2.new(-0.35, -2, 0, 0) }
	)
end
...
function module.Button.Package.Hold(Object: GuiObject) end
