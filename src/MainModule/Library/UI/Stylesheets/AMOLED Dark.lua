...
module.Window.AccentColor = Color3.fromRGB(20, 20, 20)
module.Window.BackgroundColor = Color3.fromRGB(10, 10, 10)
module.Window.ScrollBarColor = Color3.fromRGB(250, 250, 250)
module.Window.TopbarBackgroundColorIfAccentUsed = Color3.fromRGB(15, 15, 15)
...
module.Menu = {}
module.Menu.BackgroundColor = Color3.fromRGB(15, 15, 15)
...
module.Home.AvatarBackground = Color3.fromRGB(5, 5, 5)
...
module.Home.TopBackgroundColor = Color3.fromRGB(5, 5, 5)
