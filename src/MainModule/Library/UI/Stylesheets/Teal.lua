...
module.Window.AccentColor = Color3.fromRGB(49, 67, 62)
module.Window.BackgroundColor = Color3.fromRGB(33, 51, 45)
module.Window.ScrollBarColor = Color3.fromRGB(250, 250, 250)
module.Window.TopbarBackgroundColorIfAccentUsed = Color3.fromRGB(33, 51, 45)
...
module.Menu = {}
module.Menu.BackgroundColor = Color3.fromRGB(33, 51, 45)
...
module.Home.AvatarBackground = Color3.fromRGB(24, 38, 34)
...
module.Home.TopBackgroundColor = Color3.fromRGB(24, 38, 34)
